...
|---|---|---|---|---|---|---|
| Registro único de overlay activo | Como sistema, solo un overlay exclusivo puede estar activo a la vez | Alto | S | P0 | Hecho | — |
| Scrim automático | Como usuario, al abrir un overlay veo el resto de la pantalla atenuado | Alto | XS | P0 | Hecho | Registro único de overlay |
| Atenuación de widgets bajo overlay | Como usuario, mis widgets flotantes se atenúan (no se ocultan) mientras hay un overlay activo | Medio | S | P0 | Hecho | Registro único de overlay |
...
| Feature | Story | Impacto | Esfuerzo | Prioridad | Estado | Dependencias |
|---|---|---|---|---|---|---|
| Navegación primaria de 5 ítems | Como usuario, veo solo Hoy/Inbox/Proyectos/Notas/Espacios como destinos de primer nivel | Alto | S | P0 | Hecho | — |
...
| Agrupación "Sistema" | Como usuario, Ajustes/Datos/Ayuda viven detrás de un solo punto de entrada | Medio | S | P1 | Hecho | — |
| Panel/Dashboard y Papelera a navegación secundaria | Como usuario, accedo a consulta ocasional sin que ocupe espacio permanente en el sidebar | Medio | S | P1 | Hecho | Agrupación "Sistema" |
| Nombrado consistente entre plataformas | Como usuario, veo el mismo nombre de vista en escritorio y móvil | Medio | XS | P1 | Hecho | — |
