...
## Corpus Check
- 99 files · ~52,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 764 nodes · 1389 edges · 107 communities (44 shown, 63 thin omitted)
...
Cohesion: 0.18
Nodes (11): autoprefixer, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, autoprefixer, eslint-plugin-react-hooks, eslint-plugin-react-refresh, @types/react (+3 more)
