...
## Corpus Check
- 97 files · ~48,334 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 739 nodes · 1307 edges · 105 communities (44 shown, 61 thin omitted)
...
## Communities (105 total, 61 thin omitted)

### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (61): Shell(), Vista, VISTAS, VISTAS_VALIDAS, ErrorBoundary, Props, State, PendientePeek() (+53 more)

### Community 1 - "sync.tsx"
Cohesion: 0.09
Nodes (37): normalizar(), uid(), saveConfig(), CAMPOS_ESCALARES, contenidoIgual(), ItemBase, MapaSync, mergeNota() (+29 more)
...
### Community 5 - "cn"
Cohesion: 0.11
Nodes (14): HoverCardContent, PopoverContent, Progress, RadioGroup, RadioGroupItem, ScrollArea, ScrollBar, Separator (+6 more)
...
Cohesion: 0.18
Nodes (11): autoprefixer, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, autoprefixer, eslint, eslint-plugin-react-hooks (+3 more)
...
Cohesion: 0.08
Nodes (48): AdjuntosUI(), Miniatura(), ATAJOS, SINTAXIS, DIAS, Button, ButtonProps, buttonVariants (+40 more)
...
- **Why does `cn()` connect `cn` to `command.tsx`, `use-toast.ts`, `carousel.tsx`, `tabs.tsx`, `menubar.tsx`, `context-menu.tsx`, `sheet.tsx`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `card.tsx`, `toggle-group.tsx`, `alert.tsx`, `avatar.tsx`, `badge.tsx`, `accordion.tsx`, `class-variance-authority`?**
