# Graph Report - pendientes-pro  (2026-08-03)

## Corpus Check
- 103 files · ~57,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 803 nodes · 1496 edges · 109 communities (46 shown, 63 thin omitted)
...
4. `hoyISO()` - 19 edges
5. `Button` - 17 edges
6. `getSupabase()` - 16 edges
7. `CalendarioView()` - 16 edges
...
## Communities (109 total, 63 thin omitted)

### Community 0 - "App.tsx"
Cohesion: 0.50
Nodes (4): leerModoGuardado(), Modo, MODOS, PendientesView()

### Community 1 - "sync.tsx"
Cohesion: 0.08
Nodes (43): AdjuntosUI(), Miniatura(), EspacioDialog(), eliminarAdjunto(), esImagen(), formatoTamano(), leerComoDataUrl(), subirAdjunto() (+35 more)
...
Cohesion: 0.18
Nodes (11): autoprefixer, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, autoprefixer, eslint-plugin-react-hooks, eslint-plugin-react-refresh, tailwindcss-animate (+3 more)
...
Cohesion: 0.06
Nodes (75): Vista, VISTAS_VALIDAS, ATAJOS, SINTAXIS, adivinarPorEncabezado(), Columna, FilaPreview, ImportarPlanDialog() (+67 more)

### Community 32 - "cmdk"
Cohesion: 0.15
Nodes (13): embla-carousel-react, dependencies, embla-carousel-react, @radix-ui/react-radio-group, @radix-ui/react-scroll-area, @radix-ui/react-toast, @radix-ui/react-tooltip, vaul (+5 more)

### Community 34 - "embla-carousel-react"
Cohesion: 0.67
Nodes (3): Badge(), BadgeProps, badgeVariants

### Community 38 - "html-inline"
Cohesion: 0.06
Nodes (52): ErrorBoundary, Props, State, conDia(), PosponerMenu(), ProgressRing(), TaskModal(), defaultsHorario() (+44 more)
...
Cohesion: 0.10
Nodes (39): Shell(), VISTAS, CuentasGoogleDialog(), AntesEspejo, DespuesEspejo, sincronizarEspejoGoogle(), actualizarEventoAgenda(), actualizarModoEspejo() (+31 more)
...
- **Why does `dependencies` connect `cmdk` to `carousel.tsx`, `@hookform/resolvers`, `package.json`, `clsx`, `date-fns`, `lucide-react`, `next-themes`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-checkbox`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-label`, `@radix-ui/react-menubar`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-popover`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-slider`, `@radix-ui/react-slot`, `@radix-ui/react-switch`, `@radix-ui/react-toggle`, `@radix-ui/react-toggle-group`, `@radix-ui/react-tooltip`, `react-day-picker`, `react-dom`, `react-hook-form`, `react-resizable-panels`, `tailwind-merge`, `vaul`, `zod`, `@radix-ui/react-collapsible`, `tailwindcss-animate`, `@radix-ui/react-dialog`, `@radix-ui/react-context-menu`, `@radix-ui/react-tabs`, `@radix-ui/react-toast`, `@supabase/supabase-js`, `@radix-ui/react-accordion`, `cmdk`?**
  _High betweenness centrality (0.238) - this node is a cross-community bridge._
- **Why does `react` connect `carousel.tsx` to `cmdk`, `use-toast.ts`?**
  _High betweenness centrality (0.213) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `embla-carousel-react`, `command.tsx`, `use-toast.ts`, `carousel.tsx`, `menubar.tsx`, `dependencies`, `context-menu.tsx`, `sheet.tsx`, `table.tsx`, `breadcrumb.tsx`, `drawer.tsx`, `navigation-menu.tsx`, `card.tsx`, `toggle-group.tsx`, `alert.tsx`, `avatar.tsx`, `accordion.tsx`, `class-variance-authority`?**
